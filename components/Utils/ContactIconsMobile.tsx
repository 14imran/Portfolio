      ...
      <div className="left-0 right-auto flex items-center justify-center border-cyan">
        <ul className="flex space-x-6 list-none lg:flex-col">
          <li className="w-5 h-5">
            <IconLinks link="https://github.com/14imran" name="Github">
              <Github />
            </IconLinks>
          </li>
          <li className="w-5 h-5">
            <IconLinks link="https://www.linkedin.com/in/mohammedimran14/" name="Linkedin">
              <LinkedIn />
            </IconLinks>
          </li>
          <li className="w-5 h-5">
            <IconLinks link="https://www.linkedin.com/in/mohammedimran14/" name="Twitter">
              <Twitter />
            </IconLinks>
          </li>
        </ul>
