        ...
        <div className="text lg:flex-[45%]">
          ...
          <div className="mb-10 md:mb-12 lg:mb-0">
            <m.p
              ...
              viewport={{ once: true }}
            >
              Experienced Software Engineer with over 3 years of expertise in leading teams and developing Single Page Applications and implementing Object-Oriented Design patterns. Strong inclination towards learning new technologies and skills, and I am committed to mastering Testing methodologies such as Test-Driven Development and Domain-Driven Analysis Design. Additionally, I possess proficient knowledge in Cloud administration and other emerging technologies in the Cloud computing space. As a DevOps practitioner, well-versed in the best practices of Continuous Integration and Delivery, ensuring innovation and reliable software delivery
            </m.p>
            <m.p
              className="mb-6 text-lg font-normal text-text lg:text-xl"
              variants={aboutVariant}
